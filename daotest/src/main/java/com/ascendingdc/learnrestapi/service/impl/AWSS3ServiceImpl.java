...
public class AWSS3ServiceImpl implements AWSS3Service {
    ...
    public AWSS3ServiceImpl(@Value("$(aws.region)")String awsRegion){
    ...
    public Bucket createBucket(String bucketName) {
        ...
        if(!amazonS3.doesBucketExistV2(bucketName)){
            ...
            logger.info("Bucket name:{} already exists",bucketName);
        }
        return bucket;
    }
    ...
    public void deleteBucket(String bucketName) {
        try{
            ...
            logger.error("delete bucket failed with bucket name", bucketName, e.getMessage());
        }
    ...
    public String uploadMultipartFile(String bucketName, MultipartFile multipartFile) throws IOException {
        ...
        String homeDir = System.getProperty("arcane.base") != null? System.getProperty("arcane.base"): "/tmp/";
        File localFile = new File(homeDir + s3Key);
        multipartFile.transferTo(localFile);
        amazonS3.putObject("class-1801", s3Key, localFile);
        return null;
    }
