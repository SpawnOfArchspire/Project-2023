package com.ascendingdc.learnrestapi.util;
...
public class HQLStatementUtil {
     ...
     */
    public static final String HQL_SELECT_ALL_ALBUMS = "From Album";
    public static final String HQL_SELECT_ALL_BANDS = "From Band";
    public static final String HQL_SELECT_BAND_BY_ID = "FROM Band as m where b.id = :id";

    public static final String HQL_SELECT_ALBUM_WITH_CATALOG_BY_BAND_ID = "SELECT distinct b FROM Band as b " +
            "left join fetch a.albums as album left join fetch album.genres where b.id = :id";
