...
public class JDBCUtils {
    ...
    private static final String jdbcURL = "jdbc:postgresql://localhost:5432/musicrate";
//    private static final String jdbcURL = "jdbc:h2:mem:testdb";
    // JDBC driver name and database URL
//    static final String JDBC_DRIVER = "org.h2.Driver";
//    private static final String jdbcURL = "jdbc:h2:~/testdb";
    private static final String jdbcUsername = "root";    //"admin";
    private static final String jdbcPassword = "root";      //""password";
